...
from django.contrib.auth.models import (
    Permission,
)  # Required to assign User as a borrower; Required to grant the permission needed to set a book as returned.
